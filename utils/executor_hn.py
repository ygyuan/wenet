            ...
            for batch_idx, batch in enumerate(data_loader):
                ...
                with context():
                    ...
                    with torch.cuda.amp.autocast(scaler is not None):
                        loss, loss_att, loss_ctc, loss_mid_ctc = model(
                ...
                if batch_idx % log_interval == 0:
                    ...
                    if loss_mid_ctc is not None:
                        log_str += 'loss_mid_ctc {:.6f} '.format(loss_mid_ctc.item())
    ...
    def cv(self, model, data_loader, device, args):
        ...
        with torch.no_grad():
            for batch_idx, batch in enumerate(data_loader):
                ...
                if num_utts == 0:
                    continue
                loss, loss_att, loss_ctc, loss_mid_ctc = model(feats, feats_lengths, target,
                                                 target_lengths)
                ...
                if batch_idx % log_interval == 0:
                    ...
                    if loss_ctc is not None:
                        log_str += 'loss_ctc {:.6f} '.format(loss_ctc.item())
                    if loss_mid_ctc is not None:
                        log_str += 'loss_ctc {:.6f} '.format(loss_mid_ctc.item())
