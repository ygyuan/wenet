    ...
    def train(self, model, optimizer, scheduler, data_loader, device, writer,
        ...
        with model_context():
            for batch_idx, batch in enumerate(data_loader):
                key, feats, target, feats_lengths, target_lengths, target_att, target_att_lengths = batch
                #print(batch)
                ...
                with context():
                    ...
                    with torch.cuda.amp.autocast(scaler is not None):
                        loss, loss_att, loss_ctc = model(
                            feats, feats_lengths, target, target_lengths, target_att, target_att_lengths)
        ...
        with torch.no_grad():
            for batch_idx, batch in enumerate(data_loader):
                ...
                loss, loss_att, loss_ctc = model(feats, feats_lengths, target,
                                                 target_lengths, target_att, target_att_lengths)
