...
from wenet.transformer.asr_model_hn3 import init_asr_model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode',
                        choices=[
                            'attention', 'ctc_greedy_search', 'mid_ctc_greedy_search',
        ...
        for batch_idx, batch in enumerate(test_data_loader):
            ...
            if args.mode == 'attention':
                ...
                hyps = model.ctc_greedy_search(
                    ...
                    num_decoding_left_chunks=args.num_decoding_left_chunks,
                    simulate_streaming=args.simulate_streaming)
            elif args.mode == 'mid_ctc_greedy_search':
                hyps = model.mid_ctc_greedy_search(
                    feats,
                    feats_lengths,
                    decoding_chunk_size=args.decoding_chunk_size,
                    num_decoding_left_chunks=args.num_decoding_left_chunks,
            ...
            for i, key in enumerate(keys):
                ...
                logging.info('{} {}'.format(key, content1))
                fout.write('{} {}\n'.format(key, content1))
