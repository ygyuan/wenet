...
from wenet.dataset.dataset_deprecated_mixunits import AudioDataset, CollateFunc
from wenet.transformer.asr_model_mixunits2 import init_asr_model
from wenet.utils.checkpoint import load_checkpoint, save_checkpoint
from wenet.utils.executor_mixunits import Executor
...
the future, please move to the new IO !!!
    ...
    vocab_size_att = train_dataset.output_dim_att

    # Save configs to model_dir/train.yaml for inference and export
    configs['input_dim'] = input_dim
    configs['output_dim'] = vocab_size
    configs['output_dim_att'] = vocab_size_att
