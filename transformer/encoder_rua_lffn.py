...
from wenet.transformer.positionwise_feed_forward import PositionwiseLowRankFeedForward
...
class ConformerEncoder(BaseEncoder):
    ...
    def __init__(
        ...
        positionwise_layer = PositionwiseLowRankFeedForward #PositionwiseFeedForward
