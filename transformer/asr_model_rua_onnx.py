...
from wenet.transformer.decoder_onnx import (TransformerDecoder,
                                       BiTransformerDecoder)
from wenet.transformer.ctc_branch import CTCBranch
from wenet.transformer.encoder_rua_onnx import ConformerEncoder
from wenet.transformer.encoder_rua_onnx import TransformerEncoder
from wenet.transformer.label_smoothing_loss import LabelSmoothingLoss
from wenet.utils.cmvn import load_cmvn
from wenet.utils.common import (IGNORE_ID, add_sos_eos, log_add,
                                remove_duplicates_and_blank, th_accuracy,
                                reverse_pad_list)
from wenet.utils.mask_onnx import (make_pad_mask, mask_finished_preds,
...
class ASRCTCBranchCMVN(torch.nn.Module):
    ...
    def forward(
        ...
        """
        # 1. Encoder
        encoder_out, encoder_mask = self.encoder(speech, speech_lengths, decoding_chunk_size=decoding_chunk_size)
        # 2b. CTC branch
