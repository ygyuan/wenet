...
from wenet.transformer.encoder_interctc_rua import ConformerEncoder
from wenet.transformer.encoder_interctc_rua import TransformerEncoder
...
class ASRModel(torch.nn.Module):
    ...
    def _forward_encoder(
        ...
        # 1. Encoder
        if simulate_streaming == False and decoding_chunk_size <= 0:
